...
FunctionPanel::FunctionPanel(const std::string &name, bool show) : m_name(name), m_show(show)
{
    ...
    m_resource_icons["ModelFileImage"] = std::make_shared<OrdinaryTexture>("Images/model_icon.png");
    m_resource_icons["ModelAddImage"] = std::make_shared<OrdinaryTexture>("Images/model_add_icon.png");
}
