...
namespace NoobRenderer
{
    namespace render
    {
        void SSAOPass::Init(unsigned int width, unsigned int height)
        {
            ...
            m_rt->SetTexture2D<Texture2D>(GL_COLOR_ATTACHMENT0, width, height, Texture::Format::RGB, Texture::Format::RED, Texture::DataType::FLOAT);
            ...
            m_ssao->SetTexture2D<Texture2D>(GL_COLOR_ATTACHMENT0, width, height, Texture::Format::RGB, Texture::Format::RED, Texture::DataType::FLOAT);
